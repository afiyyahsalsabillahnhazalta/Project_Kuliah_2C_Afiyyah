...
<div class="col-lg-9 mt-2">
  ...
  <div class="card mt-4 border-0 bg-light">
    <div class="card-body text-center">
      <h5 class="card-title">DECAFE - APLIKASI PEMESANAN MAKANAN & MINUMAN CAFE</h5>
      <p class="card-text"> Aplikasi pemesanan makananan dan minuman yang mudah dan praktis. Nikmati beragam menu
        makanan dan minuman favorit Anda dengan beberapa klik. Pesan, Bayar dan Lacak Pesanan anda dengan mudah melalui
        aplikasi ini.
      </p>
